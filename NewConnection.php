...
<h2>Become a Part Of The Anonmymous Fiber .</h2>
...
<input type="radio" name="Service_Type" value="Individual" checked>Individual
<input type="radio" name="Service_Type" value="Business">Business<br>
...
<li id="conatiner-T&C">
  <label for="terms-checkbox">
    <input id="terms&conditions" name="terms-checkbox" type="checkbox" value="True">
...
<li id="container-submit">
  ...
  <input type="button" 
    onclick="location.href='NewConnection.php'; return false;"
    value="Cancel">
</li>
</ul>
</fieldset>
