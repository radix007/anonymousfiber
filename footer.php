<footer class="global_footer container-fluid">
    <div class=global_footer__container>
        ...
        <div class=global_footer__section>
            ...
            <ul class=global_footer__group>
                <li class=global_footer_item><a data-g-action=click data-g-event=footer data-g-label=social-media:facebook href=https://www.facebook.com>Facebook </a> <li class=global_footer_item><a data-g-action=click data-g-event=footer data-g-label=social-media:twitter href=https://twitter.com>Twitter </a> <li class=global_footer_item><a data-g-action=click data-g-event=footer data-g-label=social-media:youtube href=https://www.youtube.com>YouTube </a> <li class=global_footer_item><a data-g-action=click data-g-event=footer data-g-label=social-media:github href=https://www.github.com/radix007>Github </a> </ul> </div> <div class=global_footer__section hidden>
                                    <div class=global_footer__section__title>Translate</div>
                                    <ul class=global_footer__group>
                                        <li class=global_footer_item><a data-g-action=click data-g-event=footer href=/intl/es/ data-g-label=translate:espanol>Español</a>
                                    </ul>
        </div>
    </div>
