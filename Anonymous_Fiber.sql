...
--
-- Host: localhost
-- Generation Time: Nov 22, 2020 at 03:58 PM
...
CREATE TABLE `new_connection_req` (
  `Req_Id` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `user_details` (`First_name`, `Last_name`, `Customer_ID`, `Mobile_Number`, `Email_ID`, `Password`, `Address`, `PinCode`, `User_Type`) VALUES
('Mike', 'Ross', '1', '8757875712', 'mikeross@anonymous.com', '6d9ce3ad71855b6fff3ed3530c2967c2d4e3f844', '305 John Street , Delhi', '110005', 'Individual'),
('Emily ', 'Robinson', '2', '8969896285', 'emilyrobinson@anonymous.com', '7d762800708488ce391bc590b7893b106bec0012', '307 John Street , Delhi', '110005', 'Individual'),
('Rachel', 'Zane', '3', '7894561238', 'rachelross@anonymous.com', 'f27495a3f79f9b9b897af07fef51867f4ffecf3b', '308 John Street , Delhi', '110005', 'Individual'),
...
('Madara ', 'Uchiha', '5', '9687851273', 'madarauchiha@anonymous.com', '0b1c36f69744972bc9b19a9754da8579f5b0d63c', 'Uchiha Square , Jaipur , Rajasthan', '302010', 'Individual'),
('Legion', 'Solutions', '6', '7894561278', 'legionsolutions@anonymous.com', 'f02cf7d4585aef8b662e933bb35c4866afb99bb6', '221 Baker Street , Legion Road , New Delhi', '122011', 'Business');
